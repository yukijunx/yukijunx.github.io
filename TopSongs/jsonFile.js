// This is the separate file to load the local JSON string,
// since the album of the song ranking 362 has double quotation marks in its name
// that causes error "SyntaxError: JSON.parse: expected ',' or '}' after property value in object",
// we changed it to single quotation marks.
var jsonData=`
{
    "songs": [
        {
